...
export type AuditEntry = {
  ...
  /** The user of the user who initiated the action */
...
export type CancelSponsorshipInput = {
  ...
  /** The user of the user or organization who is acting as the sponsor, paying for the sponsorship. Required if sponsorId is not given. */
  sponsorLogin?: InputMaybe<Scalars['String']['input']>
  /** The ID of the user or organization who is receiving the sponsorship. Required if sponsorableLogin is not given. */
  sponsorableId?: InputMaybe<Scalars['ID']['input']>
  /** The user of the user or organization who is receiving the sponsorship. Required if sponsorableId is not given. */
...
export type CreatePullRequestInput = {
   ...
   * in the same network, namespace `head_ref_name` with a user like this: `user:branch`.
   */
...
export type CreateSponsorsTierInput = {
  ...
  sponsorableId?: InputMaybe<Scalars['ID']['input']>
  /** The user of the user or organization who owns the GitHub Sponsors profile. Defaults to the current user if omitted and sponsorableId is not given. */
  sponsorableLogin?: InputMaybe<Scalars['String']['input']>
...
export type Organization = Actor &
  ...
  UniformResourceLocatable & {
    ...
    /** The organization's Twitter user. */
...
export enum SponsorOrderField {
  /** Order sponsorable entities by login (user). */
  Login = 'LOGIN',
              ...
              edges: Array<{
                node: {
                  ...
                  discussion: {
                    ...
                    url: string
                    author:
                      | { avatarUrl: string; login: string; url: string }
                      | { avatarUrl: string; login: string; url: string }
                      | { avatarUrl: string; login: string; url: string }
                      | { avatarUrl: string; login: string; url: string }
                      | { avatarUrl: string; login: string; url: string }
...
export const GetDiscussionCommentsDocument = new TypedDocumentString(`
    query getDiscussionComments($query: String!) {
  search(query: $query, type: USER, first: 1) {
    edges {
      node {
    ...
    `)
export const GetIssueCommentsDocument = new TypedDocumentString(`
    query getIssueComments($query: String!) {
  search(query: $query, type: USER, first: 1) {
    edges {
      node {
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    getDiscussionComments: build.query<
      GetDiscussionCommentsQuery,
      GetDiscussionCommentsQueryVariables
    >({
      query: (variables) => ({
        document: GetDiscussionCommentsDocument as unknown as string,
        variables,
      }),
    }),
    ...
    >({
      query: (variables) => ({
        document: GetIssueCommentsDocument as unknown as string,
        variables,
      }),
    }),
