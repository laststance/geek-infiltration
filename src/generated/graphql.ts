...
export type Bot = Actor & Node & UniformResourceLocatable & {
  __typename?: 'Bot';
  /** A URL pointing to the GitHub Index's public avatar. */
  avatarUrl: Scalars['URI']['output'];
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['DateTime']['output'];
  /** Identifies the primary key from the database. */
...
export type CheckSuite = Node & {
  ...
  /** The GitHub Index which created this check suite. */
  app?: Maybe<App>;
...
export type CreateBranchProtectionRuleInput = {
  ...
  /** A list of User, Team, or Index IDs allowed to push to matching branches. */
...
export type EnterpriseOwnerInfo = {
  ...
  /** The SAML Identity Provider for the enterprise. When used by a GitHub Index, requires an installation token with read and write access to members. */
...
export type MarketplaceListing = Node & {
  ...
  /** The GitHub Index this listing represents. */
  app?: Maybe<App>;
...
export type Repository = Node & PackageOwner & ProjectOwner & RepositoryInfo & Starrable & Subscribable & UniformResourceLocatable & {
  ...
  /** Returns a boolean indicating whether the viewing username has starred this starrable. */
  viewerHasStarred: Scalars['Boolean']['output'];
  /** The users permission level on the repository. Will return null if authenticated as an GitHub Index. */
...
export type RequiredStatusCheckDescription = {
  ...
  /** The Index that must provide this status in order for it to be accepted. */
  app?: Maybe<App>;
...
export type RequiredStatusCheckInput = {
  /** The ID of the Index that must set the status in order for it to be accepted. Omit this value to use whichever app has recently been setting this status, or use "any" to allow any app to set the status. */
...
export type GetDiscussionCommentsQuery = { __typename?: 'Query', search: { __typename?: 'SearchResultItemConnection', edges?: Array<{ __typename?: 'SearchResultItemEdge', node?: { __typename?: 'App' } | { __typename?: 'Discussion' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | { __typename?: 'Repository' } | { __typename?: 'User', repositoryDiscussionComments: { __typename?: 'DiscussionCommentConnection', edges?: Array<{ __typename?: 'DiscussionCommentEdge', node?: { __typename?: 'DiscussionComment', url: any, body: string, bodyHTML: any, bodyText: string, publishedAt?: any | null, createdAt: any, author?: { __typename?: 'Bot', avatarUrl: any, login: string, url: any, resourcePath: any } | { __typename?: 'EnterpriseUserAccount', avatarUrl: any, login: string, url: any, resourcePath: any } | { __typename?: 'Mannequin', avatarUrl: any, login: string, url: any, resourcePath: any } | { __typename?: 'Organization', avatarUrl: any, login: string, url: any, resourcePath: any } | { __typename?: 'User', avatarUrl: any, login: string, url: any, resourcePath: any } | null, reactions: { __typename?: 'ReactionConnection', totalCount: number }, discussion?: { __typename?: 'Discussion', title: string, url: any, author?: { __typename?: 'Bot', avatarUrl: any, login: string, url: any } | { __typename?: 'EnterpriseUserAccount', avatarUrl: any, login: string, url: any } | { __typename?: 'Mannequin', avatarUrl: any, login: string, url: any } | { __typename?: 'Organization', avatarUrl: any, login: string, url: any } | { __typename?: 'User', avatarUrl: any, login: string, url: any } | null, repository: { __typename?: 'Repository', nameWithOwner: string } } | null } | null } | null> | null } } | null } | null> | null } };
...
export type GetIssueCommentsQuery = { __typename?: 'Query', search: { __typename?: 'SearchResultItemConnection', edges?: Array<{ __typename?: 'SearchResultItemEdge', node?: { __typename?: 'App' } | { __typename?: 'Discussion' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | { __typename?: 'Repository' } | { __typename?: 'User', issueComments: { __typename?: 'IssueCommentConnection', edges?: Array<{ __typename?: 'IssueCommentEdge', node?: { __typename?: 'IssueComment', url: any, body: string, bodyHTML: any, bodyText: string, publishedAt?: any | null, createdAt: any, author?: { __typename?: 'Bot', url: any, avatarUrl: any, login: string, resourcePath: any } | { __typename?: 'EnterpriseUserAccount', url: any, avatarUrl: any, login: string, resourcePath: any } | { __typename?: 'Mannequin', url: any, avatarUrl: any, login: string, resourcePath: any } | { __typename?: 'Organization', url: any, avatarUrl: any, login: string, resourcePath: any } | { __typename?: 'User', url: any, avatarUrl: any, login: string, resourcePath: any } | null, repository: { __typename?: 'Repository', nameWithOwner: string }, issue: { __typename?: 'Issue', title: string, url: any, author?: { __typename?: 'Bot', login: string } | { __typename?: 'EnterpriseUserAccount', login: string } | { __typename?: 'Mannequin', login: string } | { __typename?: 'Organization', login: string } | { __typename?: 'User', login: string } | null }, reactions: { __typename?: 'ReactionConnection', totalCount: number } } | null } | null> | null } } | null } | null> | null } };
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    getDiscussionComments: build.query<GetDiscussionCommentsQuery, GetDiscussionCommentsQueryVariables>({
      query: (variables) => ({ document: GetDiscussionCommentsDocument, variables })
    }),
    getIssueComments: build.query<GetIssueCommentsQuery, GetIssueCommentsQueryVariables>({
...
export const { useGetDiscussionCommentsQuery, useLazyGetDiscussionCommentsQuery, useGetIssueCommentsQuery, useLazyGetIssueCommentsQuery } = injectedRtkApi;
