...
const PullRequestAndIssueCommentsTimeline: React.FC<Props> = memo(
  ({ user }) => {
...
PullRequestAndIssueCommentsTimeline.displayName =
  'RullRequestAndIssueCommentsTimeline'

export default PullRequestAndIssueCommentsTimeline
